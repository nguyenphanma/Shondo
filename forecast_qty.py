...
df_order_plan['forecast_qty_from_alloc'] = round(df_order_plan['forecast_qty_from_alloc'], 0)

SHEETA = 'FORECAST'
shta = gs.open_by_key('1jIZl6HWBAZF4okz60J9JU-aXLjzFjjN-tzFDLK1JUYE')
worksheet_a = shta.worksheet(SHEETA)
worksheet_a.batch_clear(['A:Q'])
gd.set_with_dataframe(worksheet_a, df_order_plan)